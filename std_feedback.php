...
<html>
<head>
	<title>Feedback | Student Login</title>
</head>
<style type="text/css">
		...
		<div class="section">
			<form method="POST">
				...
				<div class="input">
					...
					<textarea name="feedback" placeholder="  Write your Feedback here.." class="textarea"></textarea>
				</div>
				...
				<?php
				          	...
				          	if (isset($_POST['insert'])) {
				          		...
				          		if (!empty($name) && !empty($mobile_no)) {
				          			# code...
				          			$insert_query = "insert into std_feedback(name, mobile_no, feedback) 
				          			values('$name', '$mobile_no', '$feedback')";
